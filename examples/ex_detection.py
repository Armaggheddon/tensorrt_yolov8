...
if __name__ == "__main__":
    ...
    model_path = "/home/Documents/Experiments/TENSORRT/tensorrt_yolov8/examples/m_export_yolov8s_fp16_dynamic.engine"
    ...
    cv2.imwrite(f"{image_path.split('.jpg')[0]}_det.jpg", img_result[0])